...
t1 = Task.create(title: "Dog or Cat", task_type: Task::TYPE_MULTIPLE_CHOICE, choices: ['Dog', 'Cat'], cost: 100, address: "moAxDkv96UfjsuqYGs5SETtSCrUR1uAGVu", balance: 0, user: u1)
t2 = Task.create(title: "Hot or Not", task_type: Task::TYPE_MULTIPLE_CHOICE, choices: ['Hot', 'Not'], cost: 200, address: "mmcbU36FhNw8EbyqgzgSDqFhhGqdygPiKk", balance: 0, user: u1)
